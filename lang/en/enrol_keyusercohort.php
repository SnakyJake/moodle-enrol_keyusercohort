...
/**
 * Strings for component 'enrol_keyusercohort', language 'en'.
 *
...
$string['pluginname'] = 'Cohort sync (keyuser)';
$string['pluginname_desc'] = 'Keyuser cohort enrolment plugin synchronises cohort members with course participants.';
$string['status'] = 'Active';
$string['creategroup'] = 'Create new group';
$string['privacy:metadata:core_group'] = 'Keyuser enrol cohort plugin can create a new group or use an existing group to add all the members of the cohort.';
